...
Les IA comme ChatGPT ou Claude font ce travail gratuitement ; elles représentent un réel progrès. Cependant, elles sont nourries de textes humains et relaient parfois certaines formulations incorrectes.
...
- Autres prestations non réglementées : sur demande, si je m’en sens capable. 

## Pour les particuliers
- Aide administrative ;
- Bricolages "multi-services" sans empiéter sur le domaine réglementés des corps de métier de type maçon, électricien, plombier ; 
...
Les collectivité ne sont pas ma clientèle coeur de cible. Mais j'ai déjà répondu à une demande un peu inhabituelle d'une commmune de l'Ain ; mon profil "couteau suisse" peut donc intéresser occasionnellement. Je suis ouvert à toute proposition.
